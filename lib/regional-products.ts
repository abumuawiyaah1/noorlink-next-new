...
export const REGIONAL_PRODUCTS: Record<RegionalRouteSlug, RegionalProduct> = {
  ...
  "north-america": {
    ...
    flag: "🌎",
    heroTagline: "USA, Canada, and Mexico on one eSIM — no plan swap at the border.",
    countries: [
      "United States",
      "Canada",
      "Mexico",
  ...
  "asia-pacific": {
    ...
    flag: "🌏",
    heroTagline: "Japan to Thailand and beyond — one QR for your Asia trip.",
    countries: [
      "Japan",
      "China",
      "India",
  ...
  "middle-east": {
    ...
    flag: "🕌",
    heroTagline:
      "Gulf, Turkey, Egypt and more — one eSIM for multi-stop Middle East trips.",
    countries: [
      "Saudi Arabia",
    ...
    exclusions: ["Lebanon", "Israel", "Tunisia", "Cyprus", "Iraq", "Iran"],
    singleCountrySlug: "turkey",
    faqBorder:
      "No. One regional plan covers every country listed on this page (Lebanon and a few nearby markets not included yet).",
  },
  africa: {
    routeSlug: "africa",
  ...
  global: {
    ...
    shortName: "Global",
    flag: "🌐",
    heroTagline: "193 countries on one plan — for long-haul and multi-region journeys.",
    countries: [
      "United States",
      "Canada",
      "United Kingdom",
